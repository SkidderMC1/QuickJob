...
export const mockUsers = {
  jasper: {
    ...
    guardianConsent: {
      ...
      maxWeeklyHours: 10,
      status: 'ACTIVE',
      authorizedAt: '2026-09-15T14:30:00.000Z',
  ...
  felix: {
    ...
    avatarText: 'FW',
    age: 12,
    ageCategory: 'CHILD_UNDER_13',
    ageCategoryLabel: 'Kind unter 13 (§ 5 Abs. 1 JArbSchG)',
    rating: 5.0,
    ratingCount: 0,
    completedJobs: 0,
    reliability: 100,
    ...
    skills: ['Gaming'],
    locationApprox: 'Wuppertal-Elberfeld',
    bio: 'Schüler (12 Jahre). Unterliegt gesetzlichem Beschäftigungsverbot.'
  },
  lena: {
    id: 'user_lena',
    name: 'Lena Sommer',
    ...
    avatarText: 'LS',
    age: 14,
    ageCategory: 'CHILD_13_14',
    ageCategoryLabel: 'Kind 13–14 (KindArbSchV)',
    rating: 4.9,
    ratingCount: 5,
    completedJobs: 5,
    reliability: 98,
